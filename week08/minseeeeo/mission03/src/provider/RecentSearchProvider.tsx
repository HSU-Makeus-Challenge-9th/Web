...
import { RECENT_SEARCHES_KEY } from "../constants/key";
...
export const RecentSearchesProvider = ({
  ...
  useEffect(() => {
    const saved = localStorage.getItem(RECENT_SEARCHES_KEY.recentSearches);
  ...
  const addRecentSearch = (query: string, type: "title" | "tag") => {
    ...
    setRecentSearches((prev) => {
      ...
      console.log(
        "실제 저장된 값:",
        localStorage.getItem(RECENT_SEARCHES_KEY.recentSearches)
      );
  ...
  const clearRecentSearches = () => {
    setRecentSearches([]);
    localStorage.removeItem(RECENT_SEARCHES_KEY.recentSearches);
  };
