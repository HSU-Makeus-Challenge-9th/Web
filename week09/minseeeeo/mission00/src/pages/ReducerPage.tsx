...
const ReducerPage = () => {
  ...
  return (
    <div className="flex flex-col gap-10 h-screen overflow-hidden justify-center items-center">
      {/* useState를 사용한 경우 */}
      <div>
      ...
      <div>
        ...
        <div className="flex justify-center gap-2">
          ...
          <button
            className="w-18 py-1 rounded-lg bg-red-600 text-white hover:bg-red-800 cursor-pointer"
