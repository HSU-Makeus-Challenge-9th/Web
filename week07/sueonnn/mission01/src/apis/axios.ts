...
//     if (!currentRefreshToken) {
//       console.error("🚨 [DEBUG 6] No refresh token, clearing auth");
//       removeAccessToken();
//       removeRefreshToken();

//       // AuthContext도 초기화 (페이지 리로드 대신)
//       if (authContextUpdateCallback) {
//         authContextUpdateCallback("", "");
//       }

//       // 페이지 리로드 대신 라우터 네비게이션 사용을 권장
//       // 하지만 현재는 window.location.href 유지
//       window.location.href = "/login";
//       return Promise.reject(error);
//     }
...
//           // 🚨 중요: AuthContext도 업데이트
//           if (authContextUpdateCallback) {
//             console.log("🚨 [DEBUG 8.5] Updating AuthContext with new tokens");
//             authContextUpdateCallback(accessToken, refreshToken);
//           } else {
//             console.warn("⚠️ AuthContext update callback not set!");
//           }
