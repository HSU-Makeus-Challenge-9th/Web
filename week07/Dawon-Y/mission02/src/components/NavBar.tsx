...
import { getMyInfo, logoutAPI } from '../api/auth';
          ...
          {!isAuthenticated ? (
            ...
            <>
              ...
              <button
                ...
                className="text-white px-3 lg:px-4 py-2 rounded-lg border border-white hover:bg-gray-800 text-sm lg:text-base disabled:opacity-50"
              >
