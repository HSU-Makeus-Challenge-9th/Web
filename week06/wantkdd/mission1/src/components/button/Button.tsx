...
const Button: React.FC<ButtonProps> = ({
  ...
  const base =
    'rounded font-medium transition-colors duration-200 flex items-center justify-center cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed';
